...
extension UILabel {
    ...
    func setAttributedTextWithClickablePart(fullText: String, clickablePart: String, clickablePartColor: UIColor = .clrPrimaryText, clickablePartFont: UIFont = .boldSystemFont(ofSize: 14), defaultFont: UIFont = .systemFont(ofSize: 14), action: Selector, target: Any) {
